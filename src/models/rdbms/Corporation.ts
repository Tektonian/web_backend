...
export type CorporationOptionalAttributes = "corp_id" | "corp_domain" | "ceo_name" | "corp_address" | "phone_number" | "biz_num" | "biz_started_at" | "corp_status" | "biz_type" | "logo_image" | "site_url";
export type CorporationCreationAttributes = Optional<CorporationAttributes, CorporationOptionalAttributes>;

export class Corporation extends Model<CorporationAttributes, CorporationCreationAttributes> implements CorporationAttributes {
  corp_id!: number;
  corp_name!: string;
  nationality!: string;
  corp_domain?: string;
